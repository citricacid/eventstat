...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta content="9957358" name="octolytics-dimension-user_id" /><meta content="clarketm" name="octolytics-dimension-user_login" /><meta content="74808045" name="octolytics-dimension-repository_id" /><meta content="clarketm/FileSaver.js" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="true" name="octolytics-dimension-repository_is_fork" /><meta content="2051226" name="octolytics-dimension-repository_parent_id" /><meta content="eligrey/FileSaver.js" name="octolytics-dimension-repository_parent_nwo" /><meta content="2051226" name="octolytics-dimension-repository_network_root_id" /><meta content="eligrey/FileSaver.js" name="octolytics-dimension-repository_network_root_nwo" />
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">citricacid</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/citricacid" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/citricacid?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
...
<ul class="pagehead-actions">
  ...
  <li>
          <a href="#fork-destination-box" class="btn btn-sm btn-with-count"
              ...
              aria-label="Fork your own copy of clarketm/FileSaver.js to your account"
              rel="facebox"
          ...
          <div id="fork-destination-box" style="display: none;">
            ...
            <include-fragment src=""
                ...
                data-url="/clarketm/FileSaver.js/fork?fragment=1">
...
--><strong itemprop="name"><a href="/clarketm/FileSaver.js" data-pjax="#js-repo-pjax-container">FileSaver.js</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/clarketm/FileSaver.js" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /clarketm/FileSaver.js" itemprop="url">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/clarketm/FileSaver.js"><span>FileSaver.js</span></a></span></span><span class="separator">/</span><strong class="final-path">FileSaver.min.js</strong>
  </div>
</div>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>11</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="eligrey" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=eligrey"><img alt="@eligrey" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/46995?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="clarketm" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=clarketm"><img alt="@clarketm" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/9957358?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="jimmywarting" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=jimmywarting"><img alt="@jimmywarting" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/1148376?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="antelle" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=antelle"><img alt="@antelle" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/633557?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="nashby" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=nashby"><img alt="@nashby" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/200500?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="Jimbly" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=Jimbly"><img alt="@Jimbly" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/774383?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="Hypercubed" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=Hypercubed"><img alt="@Hypercubed" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/509946?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="blakeembrey" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=blakeembrey"><img alt="@blakeembrey" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/1088987?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="haydenbleasel" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=haydenbleasel"><img alt="@haydenbleasel" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/4142719?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="floriangouy" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=floriangouy"><img alt="@floriangouy" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/1767167?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="ph4r05" href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js?author=ph4r05"><img alt="@ph4r05" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/1052761?v=3&amp;s=40" width="20" /> </a>
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/clarketm/FileSaver.js/raw/master/FileSaver.min.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/clarketm/FileSaver.js/blame/master/FileSaver.min.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/clarketm/FileSaver.js/commits/master/FileSaver.min.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
